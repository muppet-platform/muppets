        ...
        for file in files:
            if file.endswith(".py"):
                ...
                try:
                    ...
                    fixed_lines = ['' if line.strip() == '' else line for line in fixed_lines]
...
def main():
    ...
    exit_code, stdout, stderr = run_command("uv run flake8 src/ tests/ --max-line-length=88 --extend-ignore=E203,W503,F401,F841")
