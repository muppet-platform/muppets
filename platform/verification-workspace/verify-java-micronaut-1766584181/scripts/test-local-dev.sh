...
find . -type f \( -name "*.java" -o -name "*.gradle" -o -name "*.yml" -o -name "*.yaml" -o -name "*.md" -o -name "*.sh" -o -name "Dockerfile*" \) -exec sed -i.bak "s/verify-java-micronaut-1766584181/${TEST_MUPPET_NAME}/g" {} \;
