# Micronaut Development Guide for verify-java-micronaut-1766583658

This guide provides Micronaut-specific development patterns and best practices for your verify-java-micronaut-1766583658 muppet.
...
src/
├── main/
│   ├── java/com/muppetplatform/verify-java-micronaut-1766583658/
...
Create controllers in `src/main/java/com/muppetplatform/verify-java-micronaut-1766583658/controller/`:
...
```yaml
verify-java-micronaut-1766583658:
  feature:
    enabled: true
    timeout: 30s
```
...
Access in code:
```java
@ConfigurationProperties("verify-java-micronaut-1766583658.feature")
...
```bash
cd terraform
terraform plan -var="muppet_name=verify-java-micronaut-1766583658" -var="environment=production"
terraform apply -var="muppet_name=verify-java-micronaut-1766583658" -var="environment=production"
```
...
docker logs verify-java-micronaut-1766583658-dev

# Connect to running container
docker exec -it verify-java-micronaut-1766583658-dev /bin/sh
