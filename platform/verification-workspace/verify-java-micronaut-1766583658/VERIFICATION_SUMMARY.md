...
1. **Basic Injection**: `verify-java-micronaut-1766583658` → `test-muppet-123456`
2. **Java Package Structure**: `com.muppetplatform.verify-java-micronaut-1766583658` → `com.muppetplatform.test-muppet-123456`
