...
class ApiControllerTest {
    ...
    void testApiInfoEndpoint() {
        ...
        assertEquals("verify-java-micronaut-1766583658", response.body().get("service"));
        assertEquals("Welcome to verify-java-micronaut-1766583658 API", response.body().get("message"));
