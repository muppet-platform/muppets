...
for java_file in "${java_files[@]}"; do
    if [ -f "$java_file" ]; then
        if grep -q "verify-java-micronaut-1766583658" "$java_file"; then
        ...
        if grep -q "package com.muppetplatform.verify-java-micronaut-1766583658" "$java_file"; then
...
health_controller="src/main/java/com/muppetplatform/verify-java-micronaut-1766583658/controller/HealthController.java"
