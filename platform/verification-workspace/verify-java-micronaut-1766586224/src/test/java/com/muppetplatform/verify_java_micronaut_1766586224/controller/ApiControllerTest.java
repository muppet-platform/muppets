...
class ApiControllerTest {
    ...
    void testApiInfoEndpoint() {
        ...
        assertEquals("verify-java-micronaut-1766586224", response.body().get("service"));
        assertEquals("Welcome to verify-java-micronaut-1766586224 API", response.body().get("message"));
