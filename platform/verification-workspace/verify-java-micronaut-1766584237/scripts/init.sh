...
# verify-java-micronaut-1766584237 Muppet - Local Development Environment Setup
# This script sets up the local development environment including Rancher Desktop

set -e

echo "🚀 Setting up local development environment for verify-java-micronaut-1766584237..."
...
if [ ! -f .env.local ]; then
    ...
    cat > .env.local << EOF
# Local development environment variables for verify-java-micronaut-1766584237
MICRONAUT_ENVIRONMENTS=development
MUPPET_NAME=verify-java-micronaut-1766584237
