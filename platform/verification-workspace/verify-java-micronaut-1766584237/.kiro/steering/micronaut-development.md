# Micronaut Development Guide for verify-java-micronaut-1766584237

This guide provides Micronaut-specific development patterns and best practices for your verify-java-micronaut-1766584237 muppet.
...
src/
├── main/
│   ├── java/com/muppetplatform/verify-java-micronaut-1766584237/
...
Create controllers in `src/main/java/com/muppetplatform/verify-java-micronaut-1766584237/controller/`:
...
```yaml
verify-java-micronaut-1766584237:
  feature:
    enabled: true
    timeout: 30s
```
...
Access in code:
```java
@ConfigurationProperties("verify-java-micronaut-1766584237.feature")
...
```bash
cd terraform
terraform plan -var="muppet_name=verify-java-micronaut-1766584237" -var="environment=production"
terraform apply -var="muppet_name=verify-java-micronaut-1766584237" -var="environment=production"
```
...
docker logs verify-java-micronaut-1766584237-dev

# Connect to running container
docker exec -it verify-java-micronaut-1766584237-dev /bin/sh
