...
1. **Basic Injection**: `verify-java-micronaut-1766638048` → `test-muppet-123456`
2. **Java Package Structure**: `com.muppetplatform.verify-java-micronaut-1766638048` → `com.muppetplatform.test-muppet-123456`
