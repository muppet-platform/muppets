# Micronaut Development Guide for verify-java-micronaut-1766638048

This guide provides Micronaut-specific development patterns and best practices for your verify-java-micronaut-1766638048 muppet.
...
Create controllers in `src/main/java/com/muppetplatform/verify-java-micronaut-1766638048/controller/`:
...
Access in code:
```java
@ConfigurationProperties("verify-java-micronaut-1766638048.feature")
...
docker exec -it verify-java-micronaut-1766638048-dev /bin/sh
