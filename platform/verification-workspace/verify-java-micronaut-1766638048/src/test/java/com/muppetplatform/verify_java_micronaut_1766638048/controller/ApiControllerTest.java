...
class ApiControllerTest {
    ...
    void testApiInfoEndpoint() {
        ...
        assertEquals("verify-java-micronaut-1766638048", response.body().get("service"));
        assertEquals("Welcome to verify-java-micronaut-1766638048 API", response.body().get("message"));
