...
async def demonstrate_github_manager():
    ...
    try:
        ...
        team_permissions = {"platform-team": "admin", "demo-developers": "push"}
        ...
        logger.info(
            f"   Branch protection: {repo_info['configuration']['branch_protection']}"
        )
        ...
        success = await github_manager.add_collaborator(
            "demo-muppet", "new-developer", "push"
        )
